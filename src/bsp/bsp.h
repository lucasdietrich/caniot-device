...
#define BSP_DESCR_PORT_DEVICE_GET(_descr) GPIO_DEVICE(BSP_DESCR_GPIO_PORT_GET_INDEX(_descr))
...
/* BSP Digital IOs */
#define BSP_GPIO_DESCR_PB0 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN0 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB1 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN1 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB2 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN2 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB3 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN3 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB4 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN4 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB5 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN5 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB6 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN6 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PB7 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTB | PIN7 | BSP_DESCR_ACTIVE)

#define BSP_GPIO_DESCR_PC0 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN0 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC1 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN1 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC2 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN2 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC3 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN3 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC4 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN4 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC5 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN5 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC6 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN6 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PC7 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTC | PIN7 | BSP_DESCR_ACTIVE)

#define BSP_GPIO_DESCR_PD0 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN0 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD1 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN1 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD2 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN2 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD3 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN3 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD4 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN4 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD5 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN5 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD6 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN6 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PD7 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTD | PIN7 | BSP_DESCR_ACTIVE)

#define BSP_GPIO_DESCR_PE0 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTE | PIN0 | BSP_DESCR_ACTIVE)
#define BSP_GPIO_DESCR_PE1 (BSP_DESCR_DRIVER_GPIO | BSP_GPIO_PORTE | PIN1 | BSP_DESCR_ACTIVE)
