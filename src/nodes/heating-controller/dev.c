                        ...
                        uint8_t len)
{
    if (ep == CANIOT_ENDPOINT_APP) {
        struct caniot_heating_control *const cmds = (struct caniot_heating_control *)buf;
...
{
    if (ep == CANIOT_ENDPOINT_APP) {
        struct caniot_heating_control *const res = (struct caniot_heating_control *)buf;
...
const struct caniot_device_config default_config PROGMEM = {
    ...
    .cls1_gpio =
        {
            .self_managed = BIT(PC1_IDX) | BIT(EIO0_IDX) | BIT(EIO1_IDX) | BIT(EIO2_IDX) |
            ...
            .pulse_durations =
                {
                    ...
                    [5] = 0x0u,  [6] = 0x0u,  [7] = 0x0u,  [8] = 0x0u,  [9] = 0x0u,
                    [10] = 0x0u, [11] = 0x0u, [12] = 0x0u, [13] = 0x0u, [14] = 0x0u,
                    [15] = 0x0u, [16] = 0x0u, [17] = 0x0u, [18] = 0x0u,
                },
        },
};